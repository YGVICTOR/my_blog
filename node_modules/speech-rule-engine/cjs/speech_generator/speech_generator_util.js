...
exports.retrieveSummary = exports.connectAllMactions = exports.connectMactions = exports.retrievePrefix = exports.addPrefix = exports.addModality = exports.addSpeech = exports.recomputeMarkup = exports.computeMarkup = exports.computeSpeech = void 0;
...
function computeSummary(node, options = {}) {
    ...
    return node
        ? speech_rule_engine_js_1.SpeechRuleEngine.getInstance().runInSetting(Object.assign(preOption, { modality: 'summary', strict: false, speech: true }), function () {
            return speech_rule_engine_js_1.SpeechRuleEngine.getInstance().evaluateNode(node);
        })
        : [];
}
