...
exports.collapsePunctuated = exports.getInnerNode = exports.setOperatorAttribute = exports.rewriteMfenced = exports.cloneContentNode = exports.addCollapsedAttribute = exports.ascendNewNode = exports.introduceNewLayer = exports.walkTree = exports.enrich = void 0;
...
function getInnerNode(node) {
    ...
    for (let i = 0, remain; (remain = remainder[i]); i++) {
        if (SemanticUtil.hasEmptyTag(remain) &&
            remain.getAttribute(EnrichAttr.Attribute.TYPE) !== semantic_meaning_js_1.SemanticType.PUNCTUATION) {
