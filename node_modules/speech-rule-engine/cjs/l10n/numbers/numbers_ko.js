...
function thousandsToWords_(num) {
    ...
    str += exports.NUMBERS.ones[Math.floor(n / 1000)] ?
        (Math.floor(n / 1000) === 1 ? '천' : exports.NUMBERS.ones[Math.floor(n / 1000)] + '천') : '';
    n = n % 1000;
    if (n) {
        str += exports.NUMBERS.ones[Math.floor(n / 100)] ?
            (Math.floor(n / 100) === 1 ? '백' : exports.NUMBERS.ones[Math.floor(n / 100)] + '백') : '';
        n = n % 100;
        str += exports.NUMBERS.tens[Math.floor(n / 10)] + (n % 10 ? exports.NUMBERS.ones[n % 10] : '');
    }
    return str;
}
        ...
        if (thousands) {
            str =
                thousandsToWords_(num % 10000) +
                    (pos ? exports.NUMBERS.large[pos] + exports.NUMBERS.numSep : '') + str;
        }
